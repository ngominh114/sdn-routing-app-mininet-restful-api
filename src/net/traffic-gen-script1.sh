...
h1 for file in prepared-pcaps/h1/*.pcap; do tcpreplay --loop=100 --loopdelay-ms=1000 -i h1-eth0 --pps=10 $file & done

h2 for file in prepared-pcaps/h2/*.pcap; do tcpreplay --loop=100 --loopdelay-ms=1000 -i h2-eth0 --pps=5 $file & done

h3 for file in prepared-pcaps/h3/*.pcap; do tcpreplay --loop=100 --loopdelay-ms=1000 -i h3-eth0 --pps=9 $file & done
...
h7 for file in prepared-pcaps/h7/*.pcap; do tcpreplay --loop=100 --loopdelay-ms=1500 -i h7-eth0 --pps=6 $file & done

h8 for file in prepared-pcaps/h8/*.pcap; do tcpreplay --loop=100 --loopdelay-ms=1000 -i h8-eth0 --pps=9 $file & done

h9 for file in prepared-pcaps/h9/*.pcap; do tcpreplay --loop=100 --loopdelay-ms=1000 -i h9-eth0 --pps=12 $file & done

h10 for file in prepared-pcaps/h10/*.pcap; do tcpreplay --loop=100 --loopdelay-ms=1000 -i h10-eth0 --pps=6 $file & done
